...
abstract class AuthController
{
     ...
     */
    protected function validateRegister(array $data): array
    {
        $identifierField = $this->authConfig['fields']['identifier'];
        $passwordField = $this->authConfig['fields']['password'];
     ...
     */
    protected function prepareRegisterData(array $data): array
    {
        $passwordField = $this->authConfig['fields']['password'];
     ...
     */
    protected function prepareLoginResponse(array $user): array
    {
